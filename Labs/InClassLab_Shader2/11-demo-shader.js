...
var orbitControls, controls,
    speed = 0.01,
    toRotate = true;
var plane, plane1, material, mesh;
...
function createGeometry() {
    ...
    //__shader.uniforms.texture.value = new THREE.TextureLoader().load('assets/textures/blocks.jpg');
   ...
   mesh = new THREE.Mesh(
        new THREE.BoxGeometry(10, 10, 10,100,100),
        material
    );
